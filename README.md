# 🚀 SeedDream UI - 你的私人AI生图工具箱

<p align="center">
  <strong>基于火山引擎Seedream大模型，比公版即梦AI更好用的个人专属AI图像生成工具</strong>
</p>
...
| 模型 | 版本 | 特色能力 | 最大生成数 |
|------|------|----------|------------|
| **Seedream 5.0-pro** | 260628 | 高精度、交互编辑 🔥 | 10 |
| **Seedream 5.0-lite** | 260128 | 联网搜索 | 15 |

### 🧭 模型能力说明（更新日期：2026-08-08）

> 以下能力说明基于火山引擎官方文档整理，具体以官方文档为准。
...
| 流式输出 | ❌ | ✅ |
| 联网搜索 | ❌ | ✅ |
| 分辨率 | 1K / 1.5K / 2K | 2K / 4K |
| 输出格式 | png / jpeg | png / jpeg |
| 参考图上限 | 10 张 | 15 张（含生成数） |

> ⚠️ **5.0-pro 注意事项**：生成的图片 URL 仅保留 24 小时，请及时保存。
