...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-[#f5f7fb]/95 backdrop-blur">
      <div className="flex flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div className="min-w-0">
            ...
            <div className="mt-2">
              <div className="flex flex-wrap items-center gap-2">
                <h2 className="text-2xl font-semibold tracking-tight text-slate-950">{currentPage.title}</h2>
          ...
          <div className="flex flex-col gap-3 lg:items-end">
            <div
              className={cn(
                'inline-flex items-center gap-2 rounded-full border bg-white px-3.5 py-2 text-xs font-medium shadow-sm',
                hasApiKey
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Button
                ...
                variant="secondary"
                size="sm"
                className="h-10 rounded-full border border-slate-200 bg-white px-4 text-xs shadow-sm hover:bg-slate-50"
              >
                <Link to="/settings">
              ...
              <Button
                asChild
                size="sm"
                className="h-10 rounded-full bg-indigo-600 px-4 text-xs text-white hover:bg-indigo-700"
              >
              ...
              <Button
                ...
                variant="secondary"
                size="sm"
                className="h-10 rounded-full border border-slate-200 bg-white px-4 text-xs text-slate-700 hover:bg-slate-50"
              >
                <Link to="/series">
